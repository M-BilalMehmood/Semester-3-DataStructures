...
public:
    EmployeeData() : name(employee()), id(employee()), salary(employee()), dateOfJoining(employee()), designation(employee()) {}
...
void EmployeeDistribution(EmployeeData<EM5>* employee, S size)
{
...
EmployeeData<EM6> findEmployeeWithLongestTenure(EmployeeData<EM6>* employees, S size)
{
...
void findSalaryRange(EmployeeData<EM9>* employee, S size)
{
...
void findSalaryMediam(EmployeeData<EM10>* employee, S size)
{
...
void findEmployeeShortestTenure(EmployeeData<EM12>* employees, S size)
{
    EmployeeData<EM12> shortestTenureEmployee = employees[0];
...
void avgTenureDesignation(EmployeeData<EM13>* employee, S size)
{
    double sumSE = 0, sumSSE = 0, sumDS = 0, sumPM = 0, sumDA = 0, sumUXD = 0, sumQAA = 0;
    int noOfSE = 0, noOfSSE = 0, noOfDS = 0, noOfPM = 0, noOfDA = 0, noOfUXD = 0, noOfQAA = 0;
    int tenure = 0;
